...
public class ResourceGroup {
    ...
    private static final List<ColumnMeta> COLUMN_METAS = ImmutableList.of(
            ...
            new ColumnMeta(
                    new Column(PLAN_SCAN_PARTITIONS_LIMIT, TypeFactory.createVarchar(200)),
                    (rg, classifier) -> "" + Objects.requireNonNullElse(rg.getBigQueryScanRowsLimit(), 0)),
            new ColumnMeta(
                    new Column(PLAN_SCAN_ROWS_LIMIT, TypeFactory.createVarchar(200)),
                    (rg, classifier) -> "" + Objects.requireNonNullElse(rg.getBigQueryScanRowsLimit(), 0)),
            new ColumnMeta(
                    new Column(PLAN_SCAN_TABLETS_LIMIT, TypeFactory.createVarchar(200)),
                    (rg, classifier) -> "" + Objects.requireNonNullElse(rg.getBigQueryScanRowsLimit(), 0))
    );
